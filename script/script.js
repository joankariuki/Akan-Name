...
function getAkanName () {
  ...
  if (myGenderValue == "male" && monthValid && dayValid) {
    ...
    document.querySelector('h1').textContent = "Ete-sen," + " " + maleAkanNames[index];
    return false;
  } else if (myGenderValue == "female" && monthValid && dayValid) {
    document.getElementById('result').textContent = "You were born on a " + daysOfWeek[index] + " and your Akan name is " + femaleAkanNames[index];
    document.getElementById('display-name').textContent = "Here is your Akan name: ";
    document.getElementById('result').style.fontSize = "18px";
    document.querySelector('h1').textContent = "Ete-sen," + " " + femaleAkanNames[index];
    return false;
  } else {
